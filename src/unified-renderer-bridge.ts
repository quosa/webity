...
export class UnifiedRendererBridge {
    ...
    constructor(device: GPUDevice, context: GPUCanvasContext, wasm: WASMExports) {
        this.wasm = wasm;
    ...
    private registerDefaultMeshes(): void {
        // Generate and register sphere mesh first (use unit sphere - scaling handled by transforms)
        this.wasm.generate_sphere_mesh(32); // Higher quality, unit radius - transforms handle scaling
