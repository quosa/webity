...
export interface WASMExports {
    ...
    generate_sphere_mesh_with_radius(segments: number, radius: number): void;
    ...
    set_entity_rotation(index: number, x: number, y: number, z: number): void;
