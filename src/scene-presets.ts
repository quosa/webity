...
export function createFancyDemoScene(scene: Scene): void {
  ...
  for (let i = 0; i < 8; i++) {
    ...
    scene.createSphereGameObject(`TowerSphere_${i}`, tinyWiggleX, sphereY, tinyWiggleZ, sphereRadius);
  }
  ...
  */
  ...
  console.log('🎪 SIMPLIFIED TEST: 9 center spheres + 6 right cube tower + floor cube (left tower disabled)');
}
